...
const color = [0xF44336, 0xE91E63, 0x9C27B0, 0x673AB7, 0x3F51B5, 0x2196F3, 0x03A9F4, 0x00BCD4, 0x009688, 0x4CAF50, 0x8BC34A, 0xCDDC39, 0xFFEB3B, 0xFFC107, 0xFF9800, 0xFF5722, 0x795548, 0x9E9E9E, 0x607D8B, 0x000000, 0xFFFFFF]
    ...
    const embed = new Discord.RichEmbed()
      .setColor(color[num])
    .setImage(`https://play.pokemonshowdown.com/sprites/xyani/${sprite}.gif`);
...
exports.help = {
  name: 'gif',
  description: 'Sends the Pokemon and mega gifs.',
  usage: 'gif `pokemon name` or `pokemon name-mega`',
  module: 'Pokemon',
  permit: ' ',
  alias: ''
};
